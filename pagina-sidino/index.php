...
<div id="page-contratanos">
  ...
  <div class="ct-body">
    <a class="back-link" onclick="mostrarPagina('main')">← Volver al inicio</a>
    <div class="ct-card">

      <div id="form-view">
        <label>Nombre del colegio</label>
        <input type="text" id="f-colegio" placeholder="Nombre de la institución educativa" />

        <label>Dirección</label>
        <input type="text" id="f-dir" placeholder="Ciudad y dirección del colegio" />

        <label>Correo electrónico</label>
        <input type="email" id="f-email" placeholder="correo@tucolegio.edu.co" />
        ...
        <button class="send-btn" id="send-btn" onclick="enviarSolicitud()">Mandar solicitud</button>
      </div>
      ...
      <div class="success-state" id="success-view">
        ...
        <p>
          Hemos recibido la información de tu institución.<br>
          Pronto recibirás una respuesta de nuestro equipo en tu correo electrónico con los próximos pasos para empezar con Sidino.
        </p>
        <div class="email-chip" id="confirm-email"></div>
        <br>
        <button class="back-home-btn" onclick="mostrarPagina('main')">Volver al inicio</button>
      </div>
...
<script>
  ...
  async function enviarSolicitud() {
    ...
    try {
      const res = await fetch('enviar-solicitud.php', {
        method: 'POST',
